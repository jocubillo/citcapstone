...
if( isset($_POST['submit']) ){
  $return = delete_user($conn,$user['id']);
  if( $return ){
    $success = 1;
    $success_msg = 'User Succesfully deleted.';
  }else{
    $error = 1;
    $error_msg = 'Error : Unable to delete user. Please try again.';
  }
}
...
<html lang="en">
<head>
  <title>Admin - Delete User | CIT Capstone Project</title>
  <meta charset="utf-8">
...
<body class="d-flex flex-column h-100">
  ...
  <form action="" method="POST" class="form-signin" >
      ...
      <p>Are you sure you want to delete this user <?php echo $user['username'];?> ?</p>
